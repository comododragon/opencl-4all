...
#define PREAMBLE(reference_d, reference_dSz, input_itemsets_d, input_itemsets_dSz, cols, penalty, blk, offset_r, offset_c) {\
	int _i, _j;\
\
	srand(time(NULL));\
\
...
#define LOOPPREAMBLE(reference_d, reference_dSz, input_itemsets_d, input_itemsets_dSz, cols, penalty, blk, offset_r, offset_c, loopFlag) {\
...
#define LOOPPOSTAMBLE(reference_d, reference_dSz, input_itemsets_d, input_itemsets_dSz, cols, penalty, blk, offset_r, offset_c, loopFlag) {\
	blk++;\
}
