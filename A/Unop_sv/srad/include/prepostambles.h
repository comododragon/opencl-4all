...
void srad2_soft(float d_lambda, int d_Nr, int d_Nc, long d_Ne,
...
#define PREAMBLE(d_lambda, d_Nr, d_Nc, d_Ne,\
		d_iN, d_iNSz, d_iS, d_iSSz, d_jE, d_jESz, d_jW, d_jWSz,\
		d_dN, d_dNSz, d_dS, d_dSSz, d_dE, d_dESz, d_dW, d_dWSz,\
		d_q0sqr, d_c, d_cSz, d_I, d_ISz\
	) {\
	int _i;\
	FILE *ipf;\
\
...
#define LOOPPREAMBLE(d_lambda, d_Nr, d_Nc, d_Ne,\
		d_iN, d_iNSz, d_iS, d_iSSz, d_jE, d_jESz, d_jW, d_jWSz,\
		d_dN, d_dNSz, d_dS, d_dSSz, d_dE, d_dESz, d_dW, d_dWSz,\
		d_q0sqr, d_c, d_cSz, d_I, d_ISz,\
		loopFlag\
...
#define LOOPPOSTAMBLE(d_lambda, d_Nr, d_Nc, d_Ne,\
		d_iN, d_iNSz, d_iS, d_iSSz, d_jE, d_jESz, d_jW, d_jWSz,\
		d_dN, d_dNSz, d_dS, d_dSSz, d_dE, d_dESz, d_dW, d_dWSz,\
		d_q0sqr, d_c, d_cSz, d_I, d_ISz,\
		loopFlag\
	...
	srad2_soft(d_lambda, d_Nr, d_Nc, d_Ne, d_iN, d_iS, d_jE, d_jW, d_dN, d_dS, d_dE, d_dW, d_c, d_I);\
\
	gIndex++;\
}

#define POSTAMBLE(d_lambda, d_Nr, d_Nc, d_Ne,\
		d_iN, d_iNSz, d_iS, d_iSSz, d_jE, d_jESz, d_jW, d_jWSz,\
		d_dN, d_dNSz, d_dS, d_dSSz, d_dE, d_dESz, d_dW, d_dWSz,\
		d_q0sqr, d_c, d_cSz, d_I, d_ISz\
	) {\
